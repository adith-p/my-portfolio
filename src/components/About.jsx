        ...
        <div className="about-container">
            ...
            <div className="flex-about">
                ...
                <div className="about-text  p-2.5 text-white">
                    ...
                    <p>
                        my passion lies in creating elegant and effective solutions to complex challenges. Having a strong foundation in software development, especially backend technologies like <strong>Python</strong>, <strong>Django</strong>, <strong>Django Rest Framework</strong>, <strong>FastAPI</strong>, <strong>PostgreSQL</strong>, <strong>Celery</strong>, and <strong>Redis</strong>, I enjoy backend development.<span className="emoji">🚀</span>
                    </p>
                    <p>
                        Although I dabbled in front-end technologies like <strong>HTML5</strong>, <strong>CSS3</strong>, and <strong>JavaScript</strong>, I found my true calling in back-end development and chose to focus my efforts there.<span className="emoji">💡</span>
                    </p>
                    <p >
